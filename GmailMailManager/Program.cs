...
namespace GmailMailManager
{
    class Program
    {
        ...
        public static async void MoveLabeledMessagesToTrash(string ApplicationName, string GmailUserId, string clientfilepath , string sender)
        {
            //Cancel Task
            try
            {
                await Task.Run(() =>
                {
                    ...
                    for (; ; )
                    {
                        ...
                        allmessageslistrequest.Q = "from:"+ sender ;
                        ...
                        if (allmessages == null)
                        {
                            Console.WriteLine("All messages from " + sender + " has been deleted");
                            //  Program.CancelAllTasks();
                            break;
                        }
